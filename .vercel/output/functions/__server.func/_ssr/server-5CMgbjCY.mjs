...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BFj5OTVw.mjs");
...
const manifest = {
  "8b404eadc272d7d27f48745f2fd105c6bc74772c80d7e5eb87638d43cd197daa": {
    ...
    importer: () => import("./admin.functions-BfTInAZk.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BkwgZ6Uu.mjs").then((n) => n.W),
    import("./start-DwH7Blca.mjs"),
