...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-PBmNgTGd.mjs");
...
const manifest = {
  "8b404eadc272d7d27f48745f2fd105c6bc74772c80d7e5eb87638d43cd197daa": {
    ...
    importer: () => import("./admin.functions-B3cwFnFt.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BcrAlKxT.mjs").then((n) => n.W),
    import("./start-DfTYgKoX.mjs"),
