...
import { f as useAuth, N as Nav, F as Footer, g as sanitizeError } from "./router-BZBp0UBL.mjs";
import { s as supabase } from "./client-DYwJbDLa.mjs";
import { S as Skeleton, u as useLoyalty, T as TIERS } from "./skeleton-BwPk7GRD.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { p as User, A as Award, S as Shield, y as LogOut, G as Gift, z as Settings, J as Loader, b as Sparkles, Z as Zap, C as Clock, j as ChevronRight, K as Circle } from "../_libs/lucide-react.mjs";
...
function AccountPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "max-w-6xl mx-auto px-4 md:px-6 py-8 md:py-16", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(AccountSkeleton, {}) : user ? /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardView, { user: {
      email: user.email ?? null,
      id: user.id
    }, isAdmin, onSignOut: handleSignOut }) : /* @__PURE__ */ jsxRuntimeExports.jsx(AuthView, { mode, setMode, email, setEmail, password, setPassword, busy, onSubmit: handleSubmit }) }),
...
function DashboardView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    activeTab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsx(OverviewTab, { user, record: record ?? null, tierInfo, loading, addPoints }),
    activeTab === "rewards" && /* @__PURE__ */ jsxRuntimeExports.jsx(RewardsTab, { allRewards, record: record ?? null, tierInfo, loading, redeem }),
