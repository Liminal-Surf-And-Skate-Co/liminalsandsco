...
import {
  Plus, Trash2, Upload, ShoppingCart, Palette, Settings, Type,
  Image as ImageIcon, Sparkles, Eye, RotateCw, ChevronDown,
  Undo2, Redo2, FlipHorizontal2, FlipVertical2, MoveHorizontal,
  MoveVertical, Maximize2, Lock, Unlock, ArrowUp, ArrowDown,
  Copy, Download, Link as LinkIcon, Search, Grid3x3, Sticker,
  Layers, Zap, User, Save, Send,
} from "lucide-react";
