        ...
        <section className="py-24 border-t border-border/40 bg-background">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <h2 className="font-display font-black text-4xl lg:text-6xl leading-none mb-10">
              It started in a<br />
              <span className="text-stroke">garage.</span>
            </h2>
            <div className="space-y-5 text-silver/85 text-lg leading-relaxed max-w-2xl">
              <p>
                One winter, two friends, a borrowed planer and a stack of seconds blanks no one else
                wanted. We were tired of paying $900 for a board that snapped on its third session —
                and tired of decks that felt mass-pressed and dead under our feet.
              </p>
              <p>
                So we started shaping our own. Bad ones, then okay ones, then ones our friends asked
                for. Liminal grew out of that — a workshop making honest, durable gear that survives
                heavy street sessions and saltwater abuse, without costing a fortune.
              </p>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex items-baseline justify-between mb-10">
              <div>
                ...
                <h2 className="font-display font-black text-4xl lg:text-5xl leading-none">
                  Who's at the bench.
                </h2>
              </div>
        ...
        <section className="py-24 border-t border-border/40 bg-card/30">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-silver/70 max-w-2xl mb-10">
              The people who put our boards through their paces. Local crew, real footage, no
              marketing copy.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border border-border/60 bg-card p-7">
                ...
                <p className="text-silver/80 leading-relaxed">
                  Recycled cotton blends. Plastic-free shipping. Salvaged blanks where we can. We
                  don't have it perfect — we have it in progress. We run beach cleanups every season
                  and donate a cut of every Hand Crafted piece to local ocean conservation.
                </p>
              </div>
              <div className="border border-border/60 bg-card p-7">
                ...
                <p className="text-silver/80 leading-relaxed">
                  Skate and surf are for everyone. Every age, every body, every background, every
                  skill level. If you've never stepped on a board before, come by the shop — we'll
                  point you at the right setup and the right spot.
                </p>
              </div>
            </div>
          </div>
