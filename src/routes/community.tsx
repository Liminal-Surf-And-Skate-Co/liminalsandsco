  ...
  head: () => ({
    meta: [
      { title: "Community — Liminal Surf & Skate Co" },
      {
        name: "description",
        content:
          "Local spots, events, ride shares, and the Liminal Discord — the hub for our skate & surf community.",
      },
      { property: "og:title", content: "Community — Liminal Surf & Skate Co" },
      {
        property: "og:description",
        content: "Local spots, events, ride shares, and our Discord community.",
      },
    ],
  }),
        ...
        <section className="border-b border-border/40 py-24">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <p className="text-silver/80 text-lg max-w-2xl">
              Local spots, ride-shares, jams, and the people who keep the scene alive. Pull up, say
              hi, share a wave.
            </p>
            <a
              href={DISCORD_URL}
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-12 gap-6">
              <div className="lg:col-span-8 relative border border-border/60 bg-card aspect-[16/10] overflow-hidden">
                ...
                >
                  <path
                    d="M0,45 C20,30 40,60 60,40 S90,55 100,42 L100,0 L0,0 Z"
                    fill="oklch(0.7 0.18 290 / 0.08)"
                ...
                {mapPins.map((p) => (
                  ...
                  >
                    <span
                      className={`absolute inset-0 -m-2 rounded-full ${p.kind === "Surf" ? "bg-primary/30" : "bg-silver/30"} animate-ping`}
                    />
                    <span
                      className={`relative block h-4 w-4 rounded-full border-2 border-background ${p.kind === "Surf" ? "bg-primary" : "bg-silver"} group-hover:scale-125 transition-transform`}
                    />
                  </button>
                ))}
                {activePin && (
              ...
              <div className="lg:col-span-4 space-y-3">
                <p className="font-mono text-[10px] uppercase tracking-widest text-silver/50 mb-2">
                  {mapPins.length} pins · Updated by locals
                </p>
                {mapPins.map((p) => (
                  <button
                    key={p.id}
              ...
              <div className="lg:col-span-7">
                {submitted ? (
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="w-full inline-flex items-center justify-center gap-2 bg-gradient-purple text-primary-foreground py-4 font-mono text-xs uppercase tracking-widest shadow-glow hover:translate-y-[-2px] transition-transform"
                    >
