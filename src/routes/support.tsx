  ...
  head: () => ({
    meta: [
      { title: "Support — Liminal Surf & Skate Co" },
      {
        name: "description",
        content:
          "Help center: size charts, shipping info, returns, wetsuit care, skate gear FAQs, and how to reach us.",
      },
      ...
      <main>
        <section className="border-b border-border/40 py-20">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-silver/80 text-lg mb-8">
              Search size charts, shipping, returns, wetsuit care, skate gear — or hit us up
              directly.
            </p>
        ...
        <section className="py-20 border-b border-border/40">
          <div className="max-w-4xl mx-auto px-6 space-y-14">
            ...
            {filtered.length === 0 && (
              <p className="text-center text-silver/60 font-mono text-sm">
                No results. Try a different keyword, or reach out below.
              </p>
            )}
          </div>
        </section>
        ...
        <section className="py-20 border-b border-border/40">
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-10">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-silver/80 hover:text-primary"
                    >
                      {SUPPORT_EMAIL}
                    </a>
                    <p className="font-mono text-[10px] uppercase tracking-widest text-silver/50 mt-1">
            ...
            >
              ...
              <p className="font-mono text-[10px] uppercase tracking-widest text-silver/60 mb-4">
                We usually reply within 24 hours
              </p>
