...
export const COMMUNITY_EVENTS: CommunityEvent[] = [
  { id: "cleanup-jun-14", date: "Jun 14", title: "Beach Cleanup — North Point", detail: "9am meet at the car park. Gloves and bags provided." },
  { id: "mini-ramp-jun-22", date: "Jun 22", title: "Mini Ramp Jam", detail: "BYO board. Beers + BBQ from 4pm at the workshop." },
  { id: "paddle-jul-06", date: "Jul 06", title: "Sunrise Paddle-Out", detail: "Long-boards welcome. Coffee after at the kiosk." },
  { id: "shaping-jul-19", date: "Jul 19", title: "Shaping Workshop (Open Day)", detail: "Come watch a blank become a deck. Free entry." },
];
